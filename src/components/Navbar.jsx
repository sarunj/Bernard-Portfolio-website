...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center w-full h-20 px-4 text-white fixed bg-transparent z-10">
        <div>
      ...
      <div onClick={() => setIsNavOpen(!isNavOpen)} className='cursor-pointer z-20 text-gray-500 md:hidden' >
        ...
        {isNavOpen && (
            <ul className='flex flex-col justify-center gap-y-10 items-center bg-gradient-to-b from-black to-gray-900 bg-black w-full h-screen fixed top-0 left-0 z-10'>
